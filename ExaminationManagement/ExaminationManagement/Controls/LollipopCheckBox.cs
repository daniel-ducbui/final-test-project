...
public class LollipopCheckBox : CheckBox
{
    ...
    {
        Height = 20;
        Width = 20 + (int)CreateGraphics().MeasureString(Text, font.MavenPro_Regular15_2).Width;
    }
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        //CheckBox Text
        g.DrawString(Text, font.MavenPro_Regular15_2, new SolidBrush(Enabled ? EnabledStringColor : DisabledStringColor), 21, 0);
    }
