...
public class LollipopRadioButton : RadioButton
{
    ...
    {
        Height = 19;
        Width = 19 + (int)CreateGraphics().MeasureString(Text, font.MavenPro_Regular15_2).Width;
    }
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        //RadioButton Text
        g.DrawString(Text, font.MavenPro_Regular15_2, new SolidBrush(Enabled ? EnabledStringColor : DisabledStringColor), 20, 0);
    }
