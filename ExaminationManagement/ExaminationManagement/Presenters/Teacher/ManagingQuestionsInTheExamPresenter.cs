...
{
    public class ManagingQuestionsInTheExamPresenter
    {
        IManagingQuestionsInTheExam view;
        BindingSource bsQuestion;
        BindingSource bsTestDetails;
        BindingSource bsTheTest;
        public ManagingQuestionsInTheExamPresenter(IManagingQuestionsInTheExam examManagement)
        {
            view = examManagement;
            Initialize();
        }
